...
Non-trivial work must be tracked in an issue. If there isn't one, ask the user to file or link it. Scope the PR to that issue — do not bundle unrelated changes or expand scope opportunistically.
