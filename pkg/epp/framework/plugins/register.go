...
import (
	...
	"github.com/llm-d/llm-d-inference-scheduler/pkg/epp/framework/plugins/scheduling/picker/topkweighted"
...
func RegisterAllPlugins() {
	...
	// pickers
	plugin.Register(topkweighted.PluginType, topkweighted.PluginFactory)
}
